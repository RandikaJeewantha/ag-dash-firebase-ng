...
export class MEssentialsModifyComponent {
  ...
  temperature = new FormControl('', [Validators.pattern("^[0-9]*$")]);
  humidity = new FormControl('', [Validators.pattern("^[0-9]*$")]);
  ec_value = new FormControl('', [Validators.pattern("^[0-9]*$")]);
  ph_value = new FormControl('', [Validators.pattern("^[0-9]*$")]);
  light_value = new FormControl('', [Validators.pattern("^[0-9]*$")]);
